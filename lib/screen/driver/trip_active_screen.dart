...
class _ShimmerNavBtnState extends State<_ShimmerNavBtn>
    with SingleTickerProviderStateMixin {
  late AnimationController _ctrl;
      ...
      child: Container(
        ...
        child: Stack(alignment: Alignment.center, children: [
          ...
          const Row(mainAxisSize: MainAxisSize.min, children: [
            ...
            SizedBox(width: 10),
            Text('View Live Navigation', style: TextStyle(
...
class _TripActiveScreenState extends State<TripActiveScreen>
  ...
  void initState() {
    ...
    // Original progress bar animation (unchanged)
    ...
    for (int i = 0; i < 5; i++) {
      ...
      Future.delayed(Duration(milliseconds: 350 + i * 100),
                ...
                children: [
                  ...
                  _animated(0, Container(
                    ...
                    child: Column(children: [
                      ...
                      // ── Progress bar (original animation preserved) ──
                      Padding(
                        padding:
                  ...
                  // ── View Live Navigation shimmer (section 1) ──
                  ...
                  _animated(4, Row(children: [
                    ...
                    const SizedBox(width: 8),
                    Text(
                        'Offline – Not receiving new trips after completion',
...
// ══════════════════════════════════════════════════════
//  COMPLETE TRIP DIALOG  — animated scale-in entry
// ══════════════════════════════════════════════════════
...
class _CompleteTripDialogState extends State<_CompleteTripDialog>
  ...
  Widget build(BuildContext context) {
    ...
    final kMuted = widget.isDark
        ? Colors.white.withOpacity(0.55)
        : const Color(0xFF7A8FA6);
    final kCancel = widget.isDark
        ? const Color(0xFF1E3040)
        : const Color(0xFFF0F4F8);
...
class _ShimmerConfirmBtnState extends State<_ShimmerConfirmBtn>
    with SingleTickerProviderStateMixin {
  late AnimationController _ctrl;
  late Animation<double> _x;
