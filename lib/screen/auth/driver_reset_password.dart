...
class _DriverResetPasswordState extends State<DriverResetPassword> {
  ...
  Widget build(BuildContext context) {
    ...
    final labelBg     = t.isDark ? const Color(0xFF192C3D) : const Color(0xFFF4F7FA);
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(width: 120, height: 0.8,
                        color: t.border),
                    const SizedBox(height: 14),
                    Text('Create your new password below',
                    ...
                    SizedBox(width: 160, height: 160,
                      child: Stack(alignment: Alignment.center, children: [
                        ...
                        Icon(Icons.shield_outlined,
                            color: const Color(0xFF00D5BE).withOpacity(0.9),
                            size: 90,
                            shadows: [Shadow(
                          ...
                          Expanded(child: Column(
                            ...
                            children: [
                              Text('Password must include:',
                                  style: TextStyle(color: reqColor, fontSize: 13)),
                    ...
                    Container(width: 343, height: 52,
                      ...
                      child: ElevatedButton(
                        onPressed: () => Navigator.pushNamed(context, '/driver_otp_7'),
...
class _PassField extends StatelessWidget {
  ...
  const _PassField({
    ...
    required this.hintColor, required this.mutedColor,
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: Icon(Icons.lock_outline,
                color: const Color(0xFF00D5BE).withOpacity(0.7), size: 20),
            suffixIcon: IconButton(
              icon: Icon(
                obscure ? Icons.visibility_off_outlined : Icons.visibility_outlined,
                color: const Color(0xFF00D5BE), size: 20),
              onPressed: onToggle)))),
    ]);
  }
}
